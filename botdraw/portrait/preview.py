    ...
    *,
    ...
    out: dict[str, Any] = {
        ...
        "meta": {
            ...
            "generative": (pv.meta or {}).get("generative"),
            "generative_fidelity": (pv.meta or {}).get("generative_fidelity"),
            "ai_scene": (pv.meta or {}).get("ai_scene"),
            "orientation_deg": (pv.meta or {}).get("orientation_deg"),
            "suppress_background": (pv.meta or {}).get("suppress_background"),
            "protect_subjects": (pv.meta or {}).get("protect_subjects"),
